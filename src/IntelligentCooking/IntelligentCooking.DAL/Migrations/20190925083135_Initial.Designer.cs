            ...
            modelBuilder.Entity("IntelligentCooking.Core.Entities.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Servings = 7,
                            Stars = 1,
                            Time = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(2100)
                        },
                        new
                        {
                            Id = 2,
                            ...
                            Servings = 7,
                            Stars = 1,
                            Time = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(3600)
                        },
                        new
                        {
                            Id = 3,
                        ...
                        new
                        {
                            ...
                            Servings = 7,
                            Stars = 1,
                            Time = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(3000)
                        },
                        new
                        {
                            Id = 5,
                            ...
                            Servings = 12,
                            Stars = 1,
                            Time = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified).AddTicks(1800)
                        });
                });
