...
//         axios.post("https://localhost:5001/api/Dish",obj,config)
...
//                     </div>
//                     <div>
//                         <textarea name="recipe" onChange={this.valueChange}></textarea>
        ...
        return (
            <div className={styles.form}>
                ...
                <form>
                    ...
                    {/*    <label className={styles.label}>Recipe</label>*/}
                    {/*</div>*/}
                    <input type="button"   onClick={()=>this.createProduct(obj)} value="Create"/>
                </form>
            </div>
        )
    }
